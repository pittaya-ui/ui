...
#### 1. `list` Command ⏳
List installed and available components with detailed information.

**Features:**
- Show all available components in registry
- Show only installed components (`--installed`)
- Show only available components (`--available`)
